"""Export adapter: specpr format.

TODO: Implement write/batch_write for specpr format.
"""
...
def write(spectrum: Spectrum, path: Path) -> None:
    """Write a single spectrum to specpr format.
...
def batch_write(spectra: list[Spectrum], path: Path) -> None:
    """Write multiple spectra to specpr format.
