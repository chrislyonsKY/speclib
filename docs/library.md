...
<div class="sl-library">
  <div class="sl-controls">
    <div class="sl-search-bar">
      <input type="text" id="sl-search" placeholder="Search spectra (e.g., quartz, honeysuckle, calcite...)" aria-label="Search spectra">
    </div>
    ...
    <div class="sl-viewer-panel">
      <div class="sl-chart-container">
        ...
        <div class="sl-chart-toolbar">
          <button id="sl-btn-reset-zoom" title="Reset zoom">Reset Zoom</button>
